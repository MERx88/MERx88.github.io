...
![output](<스크린샷 2024-09-29 오후 11.56.27.png>)
_출력 결과_
...
위 컴포넌트는 분명 <Cup /> 컴포넌트를 동일하게 3번 출력하는데 아래와 같이 동일한 ui가 안그려지는걸 볼수있다.

![사이트이펙트](<스크린샷 2024-09-30 오전 12.01.56.png>)
_출력 결과_
